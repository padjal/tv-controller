...
- Phase 4 complete: dashboard — `useSSE`, `api.ts`, TVGrid, VideoLibrary, VideoPreview, CommandBar, build integration. 74 tests. Built output is served by the Rust server; playback drives real agents end to end.
